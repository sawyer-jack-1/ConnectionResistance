...
G = G.setEdgeConnection(TEST_EDGE_1(1), TEST_EDGE_1(2), CONNECTION_MATRIX);
G = G.setEdgeConnection(TEST_EDGE_2(1), TEST_EDGE_2(2), CONNECTION_MATRIX);

fprintf('Schur complement matrix L_{e^c,e^c}:');
A = SchurComp(full(G.connectionLaplacian),[TEST_EDGE_3(1)*DIM_CONNECTION-1, TEST_EDGE_3(1)*DIM_CONNECTION, TEST_EDGE_3(2)*DIM_CONNECTION-1, TEST_EDGE_3(2)*DIM_CONNECTION]);
A
